...
#102 reduces a narrow Belief/prediction-like correctness role directly to #41 task-relative response evaluation. Reading context as cue, response as prediction, and the explicit criterion as the declared outcome relation introduces no new formal structure: a predictor can be correct or incorrect by the same competence predicate. #60 already supplies predictive-correctness-without-experience-sensitive-formation under this interpretation, while the existing experience-sensitive formation and incompetent replay policy supply the converse independent product control. Thus predictive correctness and formation provenance are orthogonal in this scope. This does not reduce propositional belief, semantic content, justification, credence, probabilistic belief, full world models, or learned predictive-model formation.
