...
The number of small theorems is not itself a novelty claim. The collection is a machine-checkable record of the dependency structure. The complete set of neutral result labels is \texttt{R1}--\texttt{R21}.
