...
\item \textbf{A quotient characterization of structural admissibility.} A representation-level feature is target-admissible only if it is constant on each fiber of the proposed representation-to-target map. Equivalently, it must descend to the quotient that identifies representations assigned to the same target.
