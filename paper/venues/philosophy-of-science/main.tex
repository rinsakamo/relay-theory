...
The formal contribution separates two questions that are often compressed into one. \textbf{Structural target factorization} asks whether the feature or observed test outcome actually depends on the target assignment in the claimed way. \textbf{Scientific warrant} asks why that dependency model should be trusted in the application. The first can be machine-checked; the second cannot be obtained by declaration.
