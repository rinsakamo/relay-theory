...
The Lean 4 source used for dependency verification, its pinned toolchain, build instructions, and the R1--R23 result map are supplied as Online Resource 1. \textbf{Online Resource 1: Lean 4 dependency-verification source archive with pinned toolchain, build instructions, and R1--R23 result map.} The formal artifact verifies dependency structure only and does not establish scientific warrant.
