% Foundations of Science Standard Article adaptation.
% Venue-neutral substantive source: paper/main.tex
...
ORCID: \href{https://orcid.org/0009-0002-0443-2508}{0009-0002-0443-2508}\\
\textit{Corresponding author: \href{mailto:rin.sakamoto.research@gmail.com}{rin.sakamoto.research@gmail.com}}}
\date{}
...
\noindent\textbf{Keywords:} scientific representation; individuation; invariance; measurement; quotient structure; scientific methodology
...
The number of small theorems is not itself a novelty claim. The collection is a machine-checkable record of the dependency structure. The complete set of neutral result labels is \texttt{R1}, \texttt{R2}, \texttt{R3}, \texttt{R4}, \texttt{R5}, \texttt{R6}, \texttt{R7}, \texttt{R8}, \texttt{R9}, \texttt{R10}, \texttt{R11}, \texttt{R12}, \texttt{R13}, \texttt{R14}, \texttt{R15}, \texttt{R16}, \texttt{R17}, \texttt{R18}, \texttt{R19}, \texttt{R20}, \texttt{R21}, \texttt{R22}, and \texttt{R23}. The standalone Lean source, pinned toolchain, build instructions, and one-to-one result map are supplied as \textbf{Online Resource 1}.
...
\subsection*{Funding}
No restricted funding sources supported this submission.
...
\subsection*{Code and Supplementary Material Availability}
\textbf{Online Resource 1:} Lean 4 dependency-verification source archive with pinned toolchain, build instructions, and the R1--R23 result map. The formal artifact verifies dependency structure only and does not establish scientific warrant.

\subsection*{Author Contributions}
The sole author conceived the study, developed the conceptual framework, carried out the formal analysis, verified the manuscript-to-artifact mapping, and wrote and revised the manuscript.
