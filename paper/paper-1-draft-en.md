...
4. **A machine-checked dependency analysis with cross-domain cases.** Lean checks quotient descent and family-level separation. The main UMI case and a shorter database-record microcase show how the same failure pattern appears in distinct domains.
